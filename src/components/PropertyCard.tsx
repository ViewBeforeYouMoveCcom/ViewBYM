      ...
      <div className="grid md:grid-cols-[340px_1fr]">
        ...
        <div className="relative p-4 md:p-5">
          ...
          <button
            ...
            className="absolute right-4 top-4 rounded-full border border-[#E5E7EB] bg-white p-2 text-[#0F172A] hover:bg-[#F9FAFB]"
          >
            <svg
              width="18"
              height="18"
          ...
          <div className="flex flex-wrap items-center gap-2 pr-10">
            {property.vrEnabled ? <Badge variant="teal">Immersive VR Enabled</Badge> : null}
          ...
          <div className="mt-3 space-y-1">
            <div className="flex flex-wrap items-baseline gap-2">
              <p className="text-xl font-semibold text-[#0F172A] md:text-2xl">
                {property.price}
              </p>
            ...
            <p className="text-sm font-medium text-[#0F172A]">{property.title}</p>
          ...
          {chipTags.length ? (
            <div className="mt-3 flex flex-wrap gap-2">
              {chipTags.slice(0, 4).map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-[#E5E7EB] px-3 py-1 text-xs font-medium text-[#0F172A]"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-[#6B7280]">
              <span className="font-medium text-[#0F172A]">{property.agent.name}</span>
