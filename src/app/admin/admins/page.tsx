...
export default function AdminAdminsPage() {
  ...
  async function load() {
    ...
    const mapped: Profile[] = (data ?? []).map((p: { id: string; email: string; full_name: string | null; role: DbRole; created_at: string }) => ({
      ...p,
  ...
  async function handleRoleChange(profileId: string, newRole: Role) {
    ...
    // DB enum user_role only allows 'agent' | 'admin'; buyer = null
    const dbRole: DbRole = newRole === "buyer" ? null : newRole;
