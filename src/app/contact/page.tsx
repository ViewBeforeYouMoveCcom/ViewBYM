      ...
      <section className="relative overflow-hidden bg-[#1A3A6C] py-14 sm:py-20 lg:py-24">
        ...
        <div className="relative mx-auto max-w-[1800px] px-5">
          <div className="max-w-[640px]">
            ...
            <p className="mb-2.5 text-[12px] font-bold uppercase tracking-[.12em] text-white">Get in touch</p>
            ...
            <p className="mb-7 max-w-[520px] text-[15px] leading-relaxed text-white/70">
              Whether you&apos;re a buyer or an agent — send us a message and we&apos;ll respond promptly.
            </p>
            <div className="flex flex-wrap gap-2.5">
              <Link href="/faq" className="rounded-lg bg-white px-5 py-2.5 text-[14px] font-bold text-[#1A3A6C] transition-colors hover:bg-blue-50">
                Visit FAQs
              </Link>
              <Link href="/browse" className="rounded-lg border border-white/25 px-5 py-2.5 text-[14px] font-semibold !text-white/85 transition-colors hover:border-white/45 hover:bg-white/10">
                Browse properties
              </Link>
            </div>
          </div>
      ...
      <section className="border-b border-gray-100 bg-white py-8">
        <div className="mx-auto max-w-[1800px] px-5">
          <div className="grid gap-5 sm:grid-cols-3">
            <a href="mailto:jt@universaltvmedia.com" className="flex items-start gap-4 rounded-xl p-4 transition-colors hover:bg-gray-50 cursor-pointer">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[13px] text-gray-500">jt@universaltvmedia.com</p>
                <p className="mt-0.5 text-[12px] text-gray-400">We reply within 24 hours</p>
              </div>
            </a>

            <a href="tel:08001234567" className="flex items-start gap-4 rounded-xl p-4 transition-colors hover:bg-gray-50 cursor-pointer">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#08519A]">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="bg-gray-50 py-14 sm:py-20">
        <div className="mx-auto max-w-[1800px] px-5">
          <div className="mb-10 text-center">
            <p className="mb-2 text-[12px] font-bold uppercase tracking-[.15em] text-[#08519A]">Send a message</p>
            <h2 className="mb-2 text-[clamp(22px,3vw,32px)] font-extrabold tracking-tight text-gray-900">
              Who are you?
            </h2>
            <p className="text-[15px] text-gray-500">Choose the right form and we&apos;ll make sure it reaches the right team.</p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 max-w-[860px] mx-auto">
            ...
            <Link
              href="/contact/buyer"
              className="group flex flex-col gap-5 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all duration-200 hover:border-[#08519A] hover:shadow-lg"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#08519A]/10 transition-colors group-hover:bg-[#08519A]">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" stroke="#08519A" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white"/>
                  <circle cx="12" cy="7" r="4" stroke="#08519A" strokeWidth="1.8" className="group-hover:stroke-white"/>
                </svg>
              </div>
              <div>
                <h3 className="text-[20px] font-bold text-gray-900">I&apos;m a buyer</h3>
                <p className="mt-1.5 text-[14px] leading-relaxed text-gray-500">
                  Ask about a property, a VR tour, your saved searches, or anything else as a buyer or renter.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1.5 text-[13.5px] font-semibold text-[#08519A]">
                Buyer enquiry
            ...
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#08519A]/10 transition-colors group-hover:bg-[#08519A]">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="2" y="7" width="20" height="14" rx="2" stroke="#08519A" strokeWidth="1.8" className="group-hover:stroke-white"/>
                  <path d="M16 7V5a4 4 0 00-8 0v2" stroke="#08519A" strokeWidth="1.8" strokeLinecap="round" className="group-hover:stroke-white"/>
                  <path d="M12 14v2" stroke="#08519A" strokeWidth="2" strokeLinecap="round" className="group-hover:stroke-white"/>
                </svg>
              </div>
              <div>
                <h3 className="text-[20px] font-bold text-gray-900">I&apos;m an agent</h3>
                <p className="mt-1.5 text-[14px] leading-relaxed text-gray-500">
                  Discuss VR capture, onboarding, listing integrations, or partnership opportunities.
                </p>
              </div>
              <span className="mt-auto inline-flex items-center gap-1.5 text-[13.5px] font-semibold text-[#08519A]">
                Agent enquiry
