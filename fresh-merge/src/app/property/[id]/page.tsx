      ...
      <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6 lg:py-8">
        <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
          ...
          <div className="space-y-5">
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  {property.priceQualifier && (
                    <p className="mt-1 text-[13px] text-gray-400">{property.priceQualifier}</p>
                  )}
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {property.beds > 0 && (
                    <div className="flex items-center gap-1.5 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] px-3 py-2">
                      ...
                      <span className="text-[13px] font-semibold text-gray-700">{property.beds} <span className="font-normal text-gray-400">beds</span></span>
                    </div>
                  )}
                  {property.baths > 0 && (
                    <div className="flex items-center gap-1.5 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] px-3 py-2">
                      ...
                      <span className="text-[13px] font-semibold text-gray-700">{property.baths} <span className="font-normal text-gray-400">baths</span></span>
                    </div>
                  )}
                  {property.areaSqFt > 0 && (
                    <div className="flex items-center gap-1.5 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] px-3 py-2">
                      ...
                      <span className="text-[13px] font-semibold text-gray-700">{property.areaSqFt.toLocaleString()} <span className="font-normal text-gray-400">sq ft</span></span>
                    </div>
                  )}
                  <div className="flex items-center gap-1.5 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] px-3 py-2">
                    <span className="text-[13px] text-gray-500">{property.type}</span>
                  </div>
                  {property.tenure && (
                    <div className="flex items-center gap-1.5 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] px-3 py-2">
                      <span className="text-[13px] text-gray-500">{property.tenure}</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            {/* Photos grid */}
            <div className="rounded-2xl border border-[#E5E7EB] bg-white p-5">
              <h2 className="mb-4 text-[15px] font-bold text-gray-900">Photos</h2>
            ...
            {isDbProperty && (
              <div className="rounded-2xl border border-[#E5E7EB] bg-white p-5">
                ...
                <p className="mb-4 text-[13px] text-gray-500">Your message goes directly to {property.agent.name}.</p>
                <EnquiryForm
                  propertyId={id}
            ...
            <p className="text-[12px] text-gray-400 pb-2">
              ...
              <div className="rounded-2xl border border-[#E5E7EB] bg-white p-5 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-gray-400">{property.agent.branch}</p>
                  </div>
                </div>
                ...
                {isDbProperty && (
                  <p className="text-[12px] text-gray-400 text-center">Or use the enquiry form below</p>
                )}
              </div>
